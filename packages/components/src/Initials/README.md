...
-   [<!-- Instead, edit packages/website/src/docs/components/typography/initials.mdx -->](#---instead-edit-packageswebsitesrcdocscomponentstypographyinitialsmdx---)
-   [keywords: ["initials", "text", "user", "name"]](#keywords-initials-text-user-name)
-   [Initials](#initials)
    -   [Usage](#usage)
    -   [Props](#props)
    -   [See Also](#see-also)
