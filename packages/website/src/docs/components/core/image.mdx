...
| fit         | `CSS['objectFit']` |         | Resizes the image to fit a container, using CSS [`object-fit`](https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit). |
| height      | `CSS['height']`    |         | The image height.                                                                                                            |
| width       | `CSS['width']`     |         | The image width.                                                                                                             |
