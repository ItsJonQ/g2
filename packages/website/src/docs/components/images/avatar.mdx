...
| color              | `CSS['color']`              |            | Renders a custom background color.    |
| name               | `string`                    | `false`    | The name to render as `Initials`.     |
| shape              | `AvatarShape`               | `'circle'` | The shape of the `Avatar`.            |
| size               | `AvatarSize`,`CSS['width']` | `'medium'` | The dimensions of the `Avatar`.       |
