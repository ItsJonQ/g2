---
title: View
description: "View is the core element that renders component in the library. It is the principle component in the entire library."
type: layout
---

# View

`View` is the core element that renders component in the library. It is the principle component in the entire library.
